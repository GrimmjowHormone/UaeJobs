{{-- <x-app-layout>
    <div class="flex justify-center ">
        <div class="W-1">
            <img class="h-72" src="{{ asset('storage/imagenes/' . 'uae.jpg') }}" alt="First slide">
        </div>
    </div>
...
<x-app-layout>
    <div class="flex  ">
        <div class="w-full">
            <img class="object-cover w-full h-96" src="{{ asset('storage/imagenes/uae.jpg') }}" alt="First slide">
        </div>
    </div>
    <div class="py-16 bg-gray-50 overflow-hidden lg:py-24">
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
